      ...
      <header className="md:hidden flex items-center justify-between p-4 border-b bg-card">
        ...
        <Sheet>
          ...
          <SheetContent side="left" className="w-64 bg-sidebar text-sidebar-foreground border-sidebar-border p-0 flex flex-col">
            <div className="p-4 flex items-center gap-2 font-serif font-bold text-xl border-b border-sidebar-border/50">
              <GraduationCap className="h-6 w-6" />
            ...
            <div className="p-4 border-t border-sidebar-border/50">
              <button
                ...
                className="flex w-full items-center gap-3 px-3 py-2 rounded-md transition-colors text-sidebar-foreground/70 hover:bg-sidebar-accent/50 hover:text-sidebar-foreground"
